...
const Case2Scene4Screen = () => {
  ...
  useScreenTitle("case2.scene4.screenTitle");
  ...
  const getOptionFeedback = (findingId: string, isCorrect: boolean) => {
    ...
    return isCorrect ? t("case2.scene4.feedback.correct") : t("case2.scene4.feedback.incorrect");
  };
  ...
  const handleValidate = () => {
    ...
    if (selectedFindingIds.length === 0) {
      setMessage({
        title: t("case2.scene4.messages.emptySelection.title"),
        text: t("case2.scene4.messages.emptySelection.text"),
    ...
    if (!hasCompletedFindings) {
      setMessage({
        title: t("case2.scene4.messages.review.title"),
        text:
          selectedCorrectIds.length === 0
            ? t("case2.scene4.messages.review.selectFindings")
            : t("case2.scene4.messages.review.missingOrIncorrect"),
    ...
    setMessage({
      title: t("case2.scene4.messages.completed.title"),
      text: t("case2.scene4.messages.completed.text"),
  ...
  const handleCorrect = () => {
    ...
    setHasValidated(false);
    setMessage({
      title: t("case2.scene4.messages.readyToCorrect.title"),
      text: t("case2.scene4.messages.readyToCorrect.text"),
  ...
  const handleContinue = () => {
    if (!hasCompletedFindings) {
      setMessage({
        title: t("case2.scene4.messages.review.title"),
        text: t("case2.scene4.messages.review.correctBeforeContinue"),
        variant: MessageVariant.ERROR,
      });
      return;
    }
  ...
  return (
    <ImageBackground source={require("@images/layout/background.png")} style={GlobalStyles.container} resizeMode="contain">
      ...
      >
        <Summary
          eyebrow={t("case2.scene4.summary.eyebrow")}
          title={t("case2.scene4.summary.title")}
          description={t("case2.scene4.summary.description")}
          counterLabel={t("case2.scene4.summary.counterLabel")}
      ...
      <View style={[styles.footer, { paddingBottom: Spacing.base + insets.bottom }]}>
        {shouldShowCorrectAction && (
          <Button
            text={t("case2.scene4.actions.correct")}
        ...
        {shouldShowContinueAction && (
          <Button
            text={t("case2.scene4.actions.continue")}
        ...
        {!shouldShowCorrectAction && !shouldShowContinueAction && (
          <Button
            text={t("case2.scene4.actions.validate")}
            type={ButtonType.PRIMARY}
            style={styles.button}
...
export default Case2Scene4Screen;
