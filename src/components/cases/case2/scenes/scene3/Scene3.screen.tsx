...
const Case2Scene3Screen = () => {
  ...
  useScreenTitle("case2.scene3.screenTitle");
              ...
              {row.map((area) => (
                <View key={area.id} style={styles.optionSlot}>
                  <GroupOption
                    ...
                    onPress={() =>
                      area.flowId
                        ? navigation.navigate("Case2Scene3AssessmentFlowScreen", { assessmentId: area.flowId })
...
export default Case2Scene3Screen;
