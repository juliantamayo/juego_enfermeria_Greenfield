...
const question4Flow: Record<string, Scene2QuestionFlow> = {
  question4: {
    dialog: [
      ...
      { id: "2", speaker: "patientPcp", image: patientPcpAffectImage },
    ],
    quiz: [
      {
        id: "0",
        questionKey: "case2.scene2.questionDialogs.question4.quiz.0.question",
        answers: [
          { id: "1", textKey: "case2.scene2.questionDialogs.question4.quiz.0.answers.1" },
          { id: "2", textKey: "case2.scene2.questionDialogs.question4.quiz.0.answers.2" },
          { id: "3", textKey: "case2.scene2.questionDialogs.question4.quiz.0.answers.3", correct: true },
          { id: "4", textKey: "case2.scene2.questionDialogs.question4.quiz.0.answers.4" },
        ],
      },
    ],
