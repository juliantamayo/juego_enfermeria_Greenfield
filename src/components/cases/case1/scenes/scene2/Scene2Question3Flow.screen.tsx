...
import scene2Question3Dialogs from "./data/question3Flow";
...
type Scene2Question3FlowRouteProp = RouteProp<RootStackParamList, "Scene2Question3FlowScreen">;
...
const Scene2Question3FlowScreen = () => {
  const { t } = useTranslation();
  const navigation = useAppNavigation();
  const route = useRoute<Scene2Question3FlowRouteProp>();
  ...
  const currentQuestionFlow = scene2Question3Dialogs[questionId];
...
export default Scene2Question3FlowScreen;
