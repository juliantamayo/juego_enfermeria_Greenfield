...
import scene2Question1Dialogs from "./data/question1Flow";
...
type Scene2Question1FlowRouteProp = RouteProp<RootStackParamList, "Scene2Question1FlowScreen">;
...
const Scene2Question1FlowScreen = () => {
  const { t } = useTranslation();
  const navigation = useAppNavigation();
  const route = useRoute<Scene2Question1FlowRouteProp>();
  ...
  const currentQuestionFlow = scene2Question1Dialogs[questionId];
...
export default Scene2Question1FlowScreen;
