...
const area4Flow: Record<string, Scene3AssessmentFlow> = {
  area4: {
    dialog: [
      { id: "0", speaker: "nurse", image: muscleStrengthImage },
      { id: "1", speaker: "nurse", image: muscleStrengthImage },
    ],
    quiz: [
      {
        id: "0",
        ...
        answers: [
          { id: "1", textKey: "case1.scene3.assessmentDialogs.area4.quiz.0.answers.1", correct: true },
          { id: "2", textKey: "case1.scene3.assessmentDialogs.area4.quiz.0.answers.2" },
        ],
      },
    ],
